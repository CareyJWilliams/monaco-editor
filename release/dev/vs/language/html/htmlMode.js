...
var moduleExports = (() => {
  ...
  function toHighlighKind(kind) {
    const mKind = monaco_editor_core_exports.languages.DocumentHighlightKind;
    switch (kind) {
  ...
  function setupMode1(defaults) {
    ...
    monaco_editor_core_exports.languages.registerCompletionItemProvider(languageId, new CompletionAdapter(worker));
