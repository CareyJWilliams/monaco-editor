	...
	return (function () {
	...
	})()(
		{
			...
			6: [
				...
				{ './util/flag.js': 14, './util/form.js': 15 }
			],
			7: [
				function (require, module, exports) {
					'use strict';
			...
			15: [
				...
				{ './exact.js': 13, './flag.js': 14, './normalize.js': 16 }
			],
			16: [
				function (require, module, exports) {
					'use strict';
